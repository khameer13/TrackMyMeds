...
function loadUsers() {
  fetch("https://wide-bobcats-flash.loca.lt/users")
...
function updateUser(index, user) {
  fetch(`https://wide-bobcats-flash.loca.lt/users/${user.phone}`, {
    method: "PUT",
    headers: { "Content-Type": "application/json" },
    body: JSON.stringify(user),
  })
...
function deleteUser(index) {
  ...
  fetch(`https://wide-bobcats-flash.loca.lt/users/${userToDelete.phone}`, {
    method: "DELETE",
  })
    .then((response) => {
